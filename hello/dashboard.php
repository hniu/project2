...
<div align="center" style="font-family: 'Lato', Helvetica, sans-serif;
  	font-weight: 700;
  	font-size: 1em;
  	color: #ffffff;
  	text-transform: uppercase;"><?php if($completedcredits){echo $completedcredits;}else{echo "0";} ?>/104 credits</div><br>
<canvas id="myCanvas" width="160" height="160" align="left" style="border:0px solid #d3d3d3;">
Your browser does not support the HTML5 canvas tag.</canvas>
<h1><font color="#ffffff"><?php if($completedcredits){echo round(($completedcredits/104)*100);}else{echo "0";} ?>% complete</b></h1>(<i>of major credits</i>)</font><br>
		</td>
		<td id="spacing"></td>
...
<?php $datestr = date('Ymd'); echo date('F jS', strtotime($datestr)) . ', ' . date('Y', strtotime($datestr)); ?>
            </div> 
            </div></div>
	...
	<tr><td valign="top" bgcolor="#fff" colspan="3" style="padding:0;">
		...
		</td></tr><tr><td></td><td id="tdlast" bgcolor="#1b1d35"></td></tr></table>
	</td></tr><tr>
...
ctx.lineTo(rx,ry);
// var grd=ctx.createLinearGradient(0,0,130,40);
// grd.addColorStop(0,"#00c0a7");
// grd.addColorStop(1,"white");
